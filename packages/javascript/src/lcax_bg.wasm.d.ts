...
export const calculateProjectFromJson: (a: number, b: number) => [number, number, number, number];
export const projectSerde: (a: number, b: number) => [number, number, number, number];
